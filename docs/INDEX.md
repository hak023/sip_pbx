...
| 1.32  | [1.32.intellidecision-simulator-ux-overhaul.story.md](stories/1.32.intellidecision-simulator-ux-overhaul.story.md)                             | Review(유형 A~I 하위 탭+예시별 RAG/Tool 배지+hop_path+멀티턴 시뮬레이터 구현 완료, FR33-D, 실서버 IV만 잔여)                                                                        |
| 1.33  | [1.33.type-c-hybrid-rag-strategy.story.md](stories/1.33.type-c-hybrid-rag-strategy.story.md)                                                   | Review(유형 C 카탈로그 도메인별 병렬 하이브리드 RAG 구현 완료, FR33-E, 실서버 IV만 잔여)                                                                                            |
