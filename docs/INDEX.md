...
| Story | 문서                                                                                             | 상태 |
| ----- | ------------------------------------------------------------------------------------------------ | ---- |
| 1.41  | [1.41.upload-entrypoint-full-unification.story.md](stories/1.41.upload-entrypoint-full-unification.story.md)                                   | Draft(업로드 진입점/폼 완전 통합, FR35-A)                                                                                                                                            |
| 1.42  | [1.42.knowledge-base-data-authoring-guide.story.md](stories/1.42.knowledge-base-data-authoring-guide.story.md) | Draft(데이터 작성 가이드 문서 페이지, FR35-B)                                                                                                                  |
...
| 1.44  | [1.44.intent-explorer-intellidecision-real-chat-integration.story.md](stories/1.44.intent-explorer-intellidecision-real-chat-integration.story.md) | Draft(응대 유형 탐색기 — IntelliDecision×실제채팅 연계, FR35-D)                                                                                                                      |
| 1.45  | [1.45.type-c-hybrid-explorer-display-enhancement.story.md](stories/1.45.type-c-hybrid-explorer-display-enhancement.story.md) | Draft(유형 C 하이브리드 RAG 탐색기 표시 보강, FR35-E)                                                                                                          |
| 1.46  | [1.46.knowledge-decision-cross-navigation-and-plain-language.story.md](stories/1.46.knowledge-decision-cross-navigation-and-plain-language.story.md) | Draft(지식베이스↔응대이력 교차 탐색 + 문구 번역 계층, FR35-F)                                                                                                                        |
