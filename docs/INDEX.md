...
| [SELF_SERVICE_RAG_INTELLIDECISION_ADVANCEMENT_RESEARCH.md](design/SELF_SERVICE_RAG_INTELLIDECISION_ADVANCEMENT_RESEARCH.md)             | **(2026-07-30)** RAG·IntelliDecision 고도화 리서치 — 벤더 비종속 데이터 수집(Modular RAG/Contextual Retrieval), 지식베이스 구성 투명성, 분기별 RAG 매칭 사전 예측·hop 관리(구현 전, 방향 제시) |
