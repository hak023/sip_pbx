...
| [AI_SERVICE_AGENT_SERVICE_INTRODUCTION.md](AI_SERVICE_AGENT_SERVICE_INTRODUCTION.md)                                                                                   | **AI Service Agent 정식 보고용 서비스 소개서** — CS 실데이터, AICC 비교, 세 핵심 기능(IntelliDecision·N-hop RAG·Dynamic Tool Wrapper), 상세 판단 Statement, 대표 실행 시나리오, 안전 통제, KPI·로드맵 (v5.3) |
