...
| [AI_SERVICE_AGENT_SERVICE_INTRODUCTION.md](AI_SERVICE_AGENT_SERVICE_INTRODUCTION.md)                                                                             | **AI Service Agent 정식 보고용 서비스 소개서** — CS 실데이터, AICC 비교, 대표 실행 시나리오, IntelliDecision, 안전 통제, KPI·로드맵 (v5.1) |
