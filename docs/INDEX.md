...
| 1.31  | [1.31.upload-driven-knowledge-base-auto-assembly.story.md](stories/1.31.upload-driven-knowledge-base-auto-assembly.story.md)                   | Review(업로드 데이터 기반 매뉴얼 Q&A/설정 항목 후보/화면 노드 자동 구성 구현 완료, FR33-B, 실서버 IV만 잔여)                                                                        |
