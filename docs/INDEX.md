...
| [AI_SERVICE_AGENT_SERVICE_INTRODUCTION.md](AI_SERVICE_AGENT_SERVICE_INTRODUCTION.md)                                                                                   | **지능망 AI Service Agent PoC 소개서** — PoC 배경, 1차 통화 AI 기반, UI 텍스트 입력 기준 착신전환 단일 시나리오, 세 핵심 기술, AICC 비교, CS 적용 가능성, MCP 확장, Lessons Learned (v6.0) |
