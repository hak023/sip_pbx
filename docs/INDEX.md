...
| [AI_SERVICE_AGENT_SERVICE_INTRODUCTION.md](AI_SERVICE_AGENT_SERVICE_INTRODUCTION.md)                                                                                   | **지능망 AI Service Agent PoC 소개서** — 본인 회선만 처리하는 UI 텍스트 기반 착신전환 단일 시나리오를 통해, 기본 UI 흐름에 IntelliDecision·N-hop RAG·Dynamic Tool Wrapper를 순차적으로 확장해 설명 (v6.1) |
