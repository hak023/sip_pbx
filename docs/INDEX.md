...
| 1.30  | [1.30.knowledge-upload-entrypoint-unification.story.md](stories/1.30.knowledge-upload-entrypoint-unification.story.md)                         | Review(지식 업로드/설정 관리 진입점 통합 + 시스템 표준 고정 콘텐츠 구분 구현 완료, FR33-A/C, 실서버 IV만 잔여)                                                                      |
| 1.31  | [1.31.upload-driven-knowledge-base-auto-assembly.story.md](stories/1.31.upload-driven-knowledge-base-auto-assembly.story.md)                   | Draft(업로드 데이터만으로 매뉴얼 Q&A/설정 목록/화면 안내 3종 지식베이스 자동 구성, 도메인 비종속, FR33-B)                                                                           |
| 1.32  | [1.32.intellidecision-simulator-ux-overhaul.story.md](stories/1.32.intellidecision-simulator-ux-overhaul.story.md)                             | Draft(IntelliDecision 정책×응답 시뮬레이터 통합 — 유형 A~I 탭+질문 리스트+hop 시각화+멀티턴, FR33-D)                                                                                |
| 1.33  | [1.33.type-c-hybrid-rag-strategy.story.md](stories/1.33.type-c-hybrid-rag-strategy.story.md)                                                   | Draft(유형 C 다중 도메인 하이브리드 RAG 전략, FR33-E)                                                                                                                               |
