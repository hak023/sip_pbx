...
| 1.34  | [1.34.tool-execution-safety-design-spike.story.md](stories/1.34.tool-execution-safety-design-spike.story.md)                                   | Draft(실제 Tool 실행 안전 설계 스파이크 — 화이트리스트 승인+undo, FR34-A 선행)                                                                                                      |
| 1.35  | [1.35.upload-based-dynamic-tool-execution.story.md](stories/1.35.upload-based-dynamic-tool-execution.story.md)                                 | Draft(업로드 OpenAPI 기반 실제 Tool 실행 연결, FR34-A)                                                                                                                              |
| 1.36  | [1.36.frontend-ia-restructure-ai-agent-platform.story.md](stories/1.36.frontend-ia-restructure-ai-agent-platform.story.md)                     | Draft(Frontend IA 재편 — "AI 에이전트" 독립 플랫폼 승격, FR34-B)                                                                                                                    |
| 1.37  | [1.37.knowledge-base-tool-detail-cards-and-hop-view.story.md](stories/1.37.knowledge-base-tool-detail-cards-and-hop-view.story.md)             | Draft(지식베이스 API/Tool 단위 상세 카드+hop 뷰, FR34-C)                                                                                                                            |
| 1.38  | [1.38.intellidecision-response-flowchart-ui.story.md](stories/1.38.intellidecision-response-flowchart-ui.story.md)                             | Draft(최근 판단 이력 → 실제 대화 기반 순서도 고도화, FR34-F)                                                                                                                        |
| 1.39  | [1.39.response-simulator-integration-review.story.md](stories/1.39.response-simulator-integration-review.story.md)                             | Draft(응답 시뮬레이터 폐지 + 실제 채팅 패널 신설, FR34-E)                                                                                                                           |
| 1.40  | [1.40.intellidecision-knowledge-base-manual.story.md](stories/1.40.intellidecision-knowledge-base-manual.story.md)                             | Draft(IntelliDecision 설명 매뉴얼 전환, FR34-D)                                                                                                                                     |
