...
**통합 안내 (2026-05-11)**  
제품 요구의 **마스터 단일 진실 공급원**은 [prd.md](./prd.md)이다. 본 파일의 **요약**(제품 정의·재무 하이라이트·실행 분기)은 `prd.md`의 **「사업 맥락 및 프로젝트 계획 (요약)」** 및 **「개발 공수 (MM)」** 로 통합되었다. 아래부터는 기획 시점 **원문 전체**(시장 조사·재무·GTM·부록급 분량)를 보존한다.
