...
**작성일**: 2026-07-14
**버전**: 1.4 (2026-08-04 갱신 — 업로드 진입점 통합·업로드 데이터 기반 지식베이스 자동 구성·응답 시뮬레이터/IntelliDecision UX 통합 고도화·유형 C 하이브리드 RAG(FR33, Story 1.30~1.33))
