...
| **API/Realtime**| 동시 WSS | 5,000 (가정치) | 연동 모델에 따라 다름| 25,000호 (1:1 가정 시) | 750,000명 | 1+1 |
...
| AI Call Agent 시스템 | API/Realtime | **§6.4·연동 모델:** 코어 **~3.56 CPS** 기반 트리거 **rps** + **WSS**는 호 1:1 구독 여부에 따라 의존 | **5,000 WS** (가정, §5.5 참조) | 1 | **1 Active + 1 Standby** · 단일 VIP §1.6 |
