...
| STT Server | 1 + 1 | 32 vCPU | 128 GB | L40S x1 | NVMe 1 TB | 10 Gbps |
| TTS Server | 1 + 1 | 24 vCPU | 96 GB | L40S x1 | NVMe 1 TB | 10 Gbps |
| LLM Server | 2 + 0 | 32 vCPU | 256 GB | L40S x2 | NVMe 2 TB | 1 Gbps |
| AI Runtime | 1 + 1 | 16 vCPU | 64 GB | - | NVMe 500 GB | 10 Gbps |
| API/Realtime | 1 + 1 | 16 vCPU | 32 GB | - | NVMe 500 GB | 10 Gbps |
...
| 구분 | 금액(요약) | 상세 |
|------|------------|------|
| **하드웨어 CAPEX** | AI Call Agent **16노드(본 시나리오)** 합계 약 **344,968,000원** (ROM); 현실 범위 **약 2.8억 ~ 4.1억원**(±20%) | 11.2절 기준 |
...
| 기존 코어 | WTIMS RTP | 1 + 1 | 24 vCPU | 64 GB | - | NVMe 1 TB | 10 Gbps | RTP Relay + RTP Mirror |
| AI Call Agent 시스템 | AIR 연동 접점 GW | 1 + 1 | 8 vCPU | 32 GB | - | NVMe 200 GB | 10 Gbps | 세션 시그널만 · VIP 이중화 §2.2 |
| AI Call Agent 시스템 | STT Server | 1 + 1 | 32 vCPU | 128 GB | L40S x1 | NVMe 1 TB | 10 Gbps | gRPC streaming ASR · 625/노드(벤치) |
| AI Call Agent 시스템 | TTS Server | 1 + 1 | 24 vCPU | 96 GB | L40S x1 | NVMe 1 TB | 10 Gbps | gRPC streaming TTS · 1,000/노드(벤치) |
| AI Call Agent 시스템 | LLM Server | 2 + 0 | 32 vCPU | 256 GB | L40S x2 | NVMe 2 TB | 1 Gbps | vLLM/TGI 추론 풀 · fp8 1,500 tok/s/노드 가정 |
| AI Call Agent 시스템 | AI Runtime | 1 + 1 | 16 vCPU | 64 GB | - | NVMe 500 GB | 10 Gbps | 세션 오케스트레이션 · Active/Standby §2.2 |
| AI Call Agent 시스템 | API/Realtime (단일 VIP) | 1 + 1 | 16 vCPU | 32 GB | - | NVMe 500 GB | 10 Gbps | REST/WSS · Active가 250 WS+80 rps; 페일오버 시 Standby 인수 |
...
| STT Server (L40S x1) | 2 | 약 30,582,000 | 약 61,164,000 |
| TTS Server (L40S x1) | 2 | 약 28,647,000 | 약 57,294,000 |
| LLM Server (L40S x2, fp8 가정) | 2 | 약 54,584,000 | 약 109,168,000 |
...
| **총계(EMS 제외, AI Call Agent만)** | **16노드** | - | **약 344,968,000** |

> 범위 권고: 부품·플랫폼 ROM·리셀러 할인·유지보수 포함 여부에 따라 실제 발주가는 보통 **±20%** 편차가 발생한다.  
> 따라서 본 총액의 현실적 구매 범위는 **약 2.8억 ~ 4.1억원**으로 본다.
